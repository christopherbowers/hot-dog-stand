...
const Instructions = () => {
  return (
    <div>
      <h2>Instructions</h2>
      <h3>The Setup</h3>
      <p>It’s the busiest week of the year at the Rides-A-Lot Theme Park. You are the owner and operator of the Eats-A-Lot Hot Dog Stand, a concession stand situated in the middle of the park. You’ll start with $1,000. Make as much money as you can during this busy week!</p>
      <h3>How to Play</h3>
